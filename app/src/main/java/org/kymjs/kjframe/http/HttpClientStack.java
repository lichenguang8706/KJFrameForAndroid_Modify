...
public class HttpClientStack implements HttpStack {
    ...
    public KJHttpResponse performRequest(Request<?> request,
        ...
        if(null != entity) {
        	kjHttpResponse.setContent(entity.getContent());
            kjHttpResponse.setContentEncoding(entity.getContentEncoding().getValue());
            kjHttpResponse.setContentType(entity.getContentType().getValue());
            kjHttpResponse.setContentLength(entity.getContentLength());
        }
        kjHttpResponse.setStatusCode(response.getStatusLine().getStatusCode());
